...
export const UserForm = () => {
    ...
    const handleFormSubmit = async (values, { resetForm }) => {
        ...
        try {
            ...
            formData.append('birthday', new Date(startDate).toLocaleDateString('en-GB'));
                ...
                (
                    < div >
                        <FormUserProfile autoComplete='off' onSubmit={handleSubmit} >
                            ...
                            <UserName>{values.name ? values.name : initialValues.name}</UserName>
                                    ...
                                    <DatePickerWrapper>
                                        <Label htmlFor="birthday">
                                            ...
                                            <DatePickerStyles
                                                ...
                                                input={true}
                                                selected={startDate}
                                                onChange={(date) => { setStartDate(date); setNewBirthday(date.toLocaleDateString('en-GB')); console.log(newBirthday) }}
                            ...
                            <SubmitBtn type="submit" disabled={!dirty}>Save changes</SubmitBtn>
                        </FormUserProfile>
                    </div>
                )
                }
